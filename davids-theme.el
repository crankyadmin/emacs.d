...
;; Author: David Houston <root@crankyadmin.net>
;; Keywords: themes
;; URL: http://github.com/crankyadmin/davids-theme
;; Version: 0.1
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-doc-face ((,class (:foreground "#ffffff"))))
   `(font-lock-doc-string-face ((,class (:foreground ,yellow))))
   `(font-lock-function-name-face ((,class (:foreground ,yellow))))
   `(font-lock-keyword-face ((,class (:foreground "#8abee5"))))
   ...
   `(font-lock-string-face ((,class (:foreground "#dbe6ec"))))
   ...
   ;; IDO
   `(ido-subdir ((,class (:foreground "#dbe6ec"))))
   ...
   `(linum ((,class (:background ,current-line :foreground ,light-grey))))
   ...
   `(mode-line-buffer-id ((,class (:foreground ,blue :background nil))))
   ...
   `(org-block-background ((,class (:background "#3b444f"))))
